          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 mt-4 flex-wrap">
              <div className="flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg">
                ...
                <span className="text-slate-700 text-sm font-medium uppercase">{total} itens cadastrados</span>
              </div>
              <div className="flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg">
                <Beaker className="w-4 h-4 text-blue-600" />
                <span className="text-slate-700 text-sm font-medium uppercase">{suppliersCount} fornecedores</span>
              </div>
              {lowStock > 0 && (
                <div className="flex items-center gap-2 bg-red-100 px-3 py-1.5 rounded-lg">
                  <AlertTriangle className="w-4 h-4 text-red-600" />
                  <span className="text-red-700 text-sm font-medium uppercase">{lowStock} alertas de estoque</span>
                </div>
              )}
              <div className="flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg">
                <Beaker className="w-4 h-4 text-amber-600" />
                <span className="text-slate-700 text-sm font-medium uppercase">{chemical} produtos químicos</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-white to-slate-50 p-4 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 group hover:shadow-md hover:border-red-300 transition-all duration-300">
          ...
          <div className="min-w-0">
            ...
            <h3 className={`text-2xl font-bold ${lowStock > 0 ? 'text-red-600' : 'text-slate-800'}`}>
              {lowStock}
            </h3>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-white to-slate-50 p-4 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 group hover:shadow-md hover:border-amber-300 transition-all duration-300">
          ...
          <div className="min-w-0">
            ...
            <h3 className="text-2xl font-bold text-slate-800">{chemical}</h3>
          </div>
        </div>
      </div>
    </>
