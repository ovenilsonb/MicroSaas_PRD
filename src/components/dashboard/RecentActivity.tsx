    ...
    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col overflow-hidden group h-full transition-colors duration-300">
      ...
      <div className="p-7 flex-1 flex flex-col overflow-y-auto custom-scrollbar">
        ...
        <div className="space-y-6">
          {isLoading ? (
            <div className="py-12 text-center text-slate-400 dark:text-slate-500 text-[10px] font-black uppercase tracking-widest italic animate-pulse">Analizando Sincronização...</div>
          ) : activities.length === 0 ? (
            <div className="py-12 text-center text-slate-400 dark:text-slate-500 text-[10px] font-black uppercase tracking-widest italic">Nenhum evento detectado.</div>
          ) : (
                ...
                <div key={idx} className="flex gap-4 items-start group/item">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-slate-800 dark:text-slate-200 leading-snug">
                      ...
                      <span className="text-slate-500 dark:text-slate-400"> {config.action}.</span>
                    </p>
